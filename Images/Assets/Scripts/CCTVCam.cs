...
public class CCTVCam : MonoBehaviour
{
    ...
    [SerializeField] private CCTVSpotlightTrigger Spotlight;
    ...
    public void DeactivateCam()
    {
        ...
        transform.rotation = Quaternion.Euler(90f, yrotation,  zrotation );

       if(Spotlight != null){ Spotlight.SpotlightToDeactiveColor(); }
    }
}
