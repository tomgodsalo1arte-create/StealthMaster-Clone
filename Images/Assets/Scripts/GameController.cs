...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] private CCTVCam cctvcam;
    ...
    [SerializeField] public List<CCTVCam> camsInLevel = new List<CCTVCam>();
    ...
    public void ForceAllEnemysToBeDesabled()
    {
